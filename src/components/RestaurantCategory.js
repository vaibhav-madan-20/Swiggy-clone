...
const RestaurantCategory = ({ props, showItems, setShowIndex }) => {
    ...
    return (
        <div className="w-3/5 mx-auto my-4 bg-stone-100 rounded-lg border border-gray-300 shadow-lg p-4">
            <div className="flex justify-between cursor-pointer hover:bg-stone-200 transition-colors p-2 rounded-md" onClick={handleClick}>
